...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("SomeGameAboutWayTooManyBalls", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("SomeGameAboutWayTooManyBalls", null, 1280, 720);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["file"] = "SomeGameAboutWayTooManyBalls";
		app.meta["name"] = "SomeGameAboutWayTooManyBalls";
		...
		var attributes:lime.ui.WindowAttributes = {
			...
			parameters: {},
			resizable: true,
			title: "SomeGameAboutWayTooManyBalls",
			width: 1280,
			x: null,
			y: null,
		};
